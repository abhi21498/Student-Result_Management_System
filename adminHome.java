...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("ADD STUDENTS RESULTS");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "EEE", "MECH", "CIVIL" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BTECH", "BCOM", "BSC", "BA" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String course = (String)jComboBox3.getSelectedItem();
         String branchname = (String)jComboBox2.getSelectedItem();
          ...
          st.executeUpdate("insert into student(rollno,course,branchame,name,gender,fathername) values('"+roll+"','"+course+"','"+branchname+"','"+name+"','"+gender+"','"+fathername+"')");
